...
struct addressing_data addressing[(0xFF) + 1] = {
    ...
    {&LSR, "LSR", ZEROPAGE, 2, 5}, {&SRE, "SRE", ZEROPAGE, 2, 5}, {&PHA, "PHA", IMPLICIT, 1, 3}, {&EOR, "EOR", IMMEDIATE, 2, 2}, {&LSR, "LSR", ACCUMULATOR, 1, 2}, {&ALR, "ALR", IMMEDIATE, 2, 2}, {&JMP, "JMP", ABSOLUTE, 3, 3}, {&EOR, "EOR", ABSOLUTE, 3, 4}, {&LSR, "LSR", ABSOLUTE, 3, 6}, {&SRE, "SRE", ABSOLUTE, 3, 6},
    ...
    {&NOP, "NOP", IMMEDIATE, 2, 2}, {&SAX, "SAX", INDIRECTX, 2, 6}, {&STY, "STY", ZEROPAGE, 2, 3}, {&STA, "STA", ZEROPAGE, 2, 3}, {&STX, "STX", ZEROPAGE, 2, 3}, {&SAX, "SAX", ZEROPAGE, 2, 3}, {&DEY, "DEY", IMPLICIT, 1, 2}, {&NOP, "NOP", IMMEDIATE, 2, 2}, {&TXA, "TXA", IMPLICIT, 1, 2}, {&XAA, "XAA", IMMEDIATE, 2, 2},
    {&STY, "STY", ABSOLUTE, 3, 4}, {&STA, "STA", ABSOLUTE, 3, 4}, {&STX, "STX", ABSOLUTE, 3, 4}, {&SAX, "SAX", ABSOLUTE, 3, 4}, {&BCC, "BCC", RELATIVE, 2, 2}, {&STA, "STA", INDIRECTY, 2, 6}, {&KIL, "KIL", IMPLICIT, 1, 1}, {&AXA, "AXA", INDIRECTY, 2, 6}, {&STY, "STY", ZEROPAGEX, 2, 4}, {&STA, "STA", ZEROPAGEX, 2, 4},
    // 150
    {&STX, "STX", ZEROPAGEY, 2, 4}, {&SAX, "SAX", ZEROPAGEY, 2, 4}, {&TYA, "TYA", IMPLICIT, 1, 2}, {&STA, "STA", ABSOLUTEY, 3, 5}, {&TXS, "TXS", IMPLICIT, 1, 2}, {&TAS, "TAS", ABSOLUTEY, 3, 5}, {&SHY, "SHY", ABSOLUTEX, 3, 5}, {&STA, "STA", ABSOLUTEX, 3, 5}, {&SHX, "SHX", ABSOLUTEY, 3, 5}, {&AXA, "AXA", ABSOLUTEY, 3, 5},
    ...
    {&LDX, "LDX", ABSOLUTEY, 3, -4}, {&LAX, "LAX", ABSOLUTEY, 3, -4}, {&CPY, "CPY", IMMEDIATE, 2, 2}, {&CMP, "CMP", INDIRECTX, 2, 6}, {&NOP, "NOP", IMMEDIATE, 2, 2}, {&DCP, "DCP", INDIRECTX, 2, 8}, {&CPY, "CPY", ZEROPAGE, 2, 3}, {&CMP, "CMP", ZEROPAGE, 2, 3}, {&DEC, "DEC", ZEROPAGE, 2, 5}, {&DCP, "DCP", ZEROPAGE, 2, 5},
    // 200
    {&INY, "INY", IMPLICIT, 1, 2}, {&CMP, "CMP", IMMEDIATE, 2, 2}, {&DEX, "DEX", IMPLICIT, 1, 2}, {&AXS, "AXS", IMMEDIATE, 2, 2}, {&CPY, "CPY", ABSOLUTE, 3, 4}, {&CMP, "CMP", ABSOLUTE, 3, 4}, {&DEC, "DEC", ABSOLUTE, 3, 6}, {&DCP, "DCP", ABSOLUTE, 3, 6}, {&BNE, "BNE", RELATIVE, 2, 2}, {&CMP, "CMP", INDIRECTY, 2, -5},
    {&KIL, "KIL", IMPLICIT, 1, 1}, {&DCP, "DCP", INDIRECTY, 2, 8}, {&NOP, "NOP", ABSOLUTEX, 2, 1}, {&CMP, "CMP", ZEROPAGEX, 2, 4}, {&DEC, "DEC", ZEROPAGEX, 2, 6}, {&DCP, "DCP", ZEROPAGEX, 2, 6}, {&CLD, "CLD", IMPLICIT, 1, 2}, {&CMP, "CMP", ABSOLUTEY, 3, -4}, {&NOP, "NOP", IMPLICIT, 1, 1}, {&DCP, "DCP", ABSOLUTEY, 3, 7},
    {&NOP, "NOP", INDIRECT, 3, 1}, {&CMP, "CMP", ABSOLUTEX, 3, -4}, {&DEC, "DEC", ABSOLUTEX, 3, 7}, {&DCP, "DCP", ABSOLUTEX, 3, 7}, {&CPX, "CPX", IMMEDIATE, 2, 2}, {&SBC, "SBC", INDIRECTX, 2, 6}, {&NOP, "NOP", IMMEDIATE, 2, 2}, {&ISC, "ISC", INDIRECTX, 2, 8}, {&CPX, "CPX", ZEROPAGE, 2, 3}, {&SBC, "SBC", ZEROPAGE, 2, 3},
    {&INC, "INC", ZEROPAGE, 2, 5}, {&ISC, "ISC", ZEROPAGE, 2, 5}, {&INX, "INX", IMPLICIT, 1, 2}, {&SBC, "SBC", IMMEDIATE, 2, 2}, {&NOP, "NOP", IMPLICIT, 1, 2}, {&SBC, "SBC", IMMEDIATE, 2, 2}, {&CPX, "CPX", ABSOLUTE, 3, 4}, {&SBC, "SBC", ABSOLUTE, 3, 4}, {&INC, "INC", ABSOLUTE, 3, 6}, {&ISC, "ISC", ABSOLUTE, 3, 6},
    {&BEQ, "BEQ", RELATIVE, 2, 2}, {&SBC, "SBC", INDIRECTY, 2, -5}, {&KIL, "KIL", IMPLICIT, 1, 1}, {&ISC, "ISC", INDIRECTY, 2, 8}, {&NOP, "NOP", ABSOLUTEX, 2, 1}, {&SBC, "SBC", ZEROPAGEX, 2, 4}, {&INC, "INC", ZEROPAGEX, 2, 6}, {&ISC, "ISC", ZEROPAGEX, 2, 6}, {&SED, "SED", IMPLICIT, 1, 2}, {&SBC, "SBC", ABSOLUTEY, 3, -4},
    // 250
