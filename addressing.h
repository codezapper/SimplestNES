...
struct addressing_data addressing[(0xFF) + 1] = {
    ...
    {&PLP, IMPLICIT, 4}, {&AND, IMMEDIATE, 2}, {0, 0, 0}, {0, 0, 0}, {&BIT, ABSOLUTE, 4}, {&AND, ABSOLUTE, 4}, {0, 0, 0}, {0, 0, 0}, {&BMI, RELATIVE, 2}, {&AND, INDIRECTY, -5},
    // 50
    ...
    {0, 0, 0}, {0, 0, 0}, {0, 0, 0}, {&EOR, ABSOLUTEX, -4}, {&LSR, ABSOLUTEX, 7}, {0, 0, 0}, {0, 0, 0}, {&ADC, INDIRECTX, 6}, {0, 0, 0}, {0, 0, 0},
    // 100
    {0, 0, 0}, {&ADC, ZEROPAGE, 3}, {0, 0, 0}, {0, 0, 0}, {&PLA, IMPLICIT, 4}, {&ADC, IMMEDIATE, 2}, {0, 0, 0}, {0, 0, 0}, {&JMP, INDIRECT, 5}, {&ADC, ABSOLUTE, 4},
    ...
    {&INC, ZEROPAGE, 5}, {0, 0, 0}, {&INX, IMPLICIT, 2}, {0, 0, 0}, {&NOP, IMPLICIT, 2}, {0, 0, 0}, {&CMP, ABSOLUTE, 4}, {0, 0, 0}, {&INC, ABSOLUTE, 6}, {0, 0, 0},
